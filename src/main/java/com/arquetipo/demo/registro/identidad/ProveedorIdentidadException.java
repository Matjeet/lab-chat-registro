 ...
 * servicio, error interno del proveedor, etc.). El {@code GlobalExceptionHandler} la trata
 * como cualquier excepcion no controlada: 500 con detalle generico para el cliente; el
